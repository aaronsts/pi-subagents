...
Unit tests cover path normalization, deny rules, and role prompts and launch arguments. Manual smoke testing is opt-in because it makes paid model calls: run Pi with the package enabled and explicitly request one read-only role.
